...
SVC_NAME="actions.runner.Saayyaaaa-Linux-SIS5-Ansible.saya-VirtualBox.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (Saayyaaaa-Linux-SIS5-Ansible.saya-VirtualBox)"
